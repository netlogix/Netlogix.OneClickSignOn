 ...
 */
class OneClickToken implements \TYPO3\FLOW3\Security\Authentication\TokenInterface {
	...
	public function updateCredentials(\TYPO3\FLOW3\MVC\RequestInterface $request) {
		...
		$expires = \TYPO3\FLOW3\Reflection\ObjectAccess::getPropertyPath($getArguments, '__authentication.TYPO3.FLOW3.Security.Authentication.Token.OneClick.expires');
